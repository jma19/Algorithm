...
public class DPEditDistance {
    ...
    public void printEditDistance() {
        ...
        for (int i = 0; i < y.length() + 1; i++) {
            for (int j = 0; j < x.length() + 1; j++) {
                System.out.print(t[i][j].cost + " ");
            }
            System.out.println();
        }
        System.out.println("final cost:" + t[y.length()][x.length()].cost);
...
//        System.out.println("Edit Distance: " + t[y.length()][x.length()].cost);
    ...
    public static void main(String[] args) {
        DPEditDistance editDistance = new DPEditDistance("electrical engineering", "computer science");
