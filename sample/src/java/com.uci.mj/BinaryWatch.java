...
/**
 * Created by junm5 on 9/27/16.
 */
public class BinaryWatch {

    private void trackingBack(List<Integer> res, int num, int tempRes, int start) {
        if (num == 0) {
            res.add(tempRes);
            return;
        }
